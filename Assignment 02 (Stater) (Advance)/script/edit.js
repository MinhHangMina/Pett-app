...
// Hàm sử lý khi người dùng nhấn vào nút edit
function editEvent() {
...
const breedStorage = JSON.parse(localStorage.getItem("breedArr"));
const mapBreed = breedStorage.map((breed) => breed.breed);
...
function renderBreed() {
  ...
  if (typeInput.value === "Dog") {
    breedDogs.forEach(function (breedItem) {
      ...
      option.innerHTML += `<option>${breedItem.breed}</option>`;
